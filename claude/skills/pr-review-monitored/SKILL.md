---
name: pr-review-monitored
description: |
  PR review orchestrator with progress monitoring. Launches background orchestrator and polls progress to update TaskList in parent context.
  Use this when you want real-time progress updates. For silent background execution, use pr-review skill directly.

  Triggers: "review PR with monitoring", "monitored PR review", "review PR and show progress"
context: fork
agent: foreground
model: sonnet
allowed-tools:
